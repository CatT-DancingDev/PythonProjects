...
# Module:       seriesResonantCircuit.py
...
#
#
# Description:  This module defines/implements the subclass seriesResonantCircuit, which extends
#               the class Resonant Circuit by adding a method to design the series circuit for
...
#
# Parameters:   self
# Return Value: SeriesResonantCircuit object
#
...
#               Series Resonant Circuit Design Values
#
####################################################################################################
    ...
    def display(self):
        ...
        # Add Series Circuit Design
        print("SERIES CIRCUIT DESIGN")
